...
<html>
<head>
    <title>一拍 · 即合-校易聘-最专业的互联网招聘平台</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css"
          href="{{env('APP_HOST')}}/yi/jquery.mCustomScrollbar.min.css?v=1.5.5.7_102001"/>
</head>
<body>
<div class="pai-nav">
    <div class="pai-nav-top">
        <ul class="top-right">
            <li class="msg_dropdown unreaded">
                ...
                <div class="lg_msg_popup">
                    ...
                    <div class="lg_msg_pu_footer">
                        <a href="http://www.lagou.com/message/settingsdetail.html" class="lg_msg_setting fl"
                           target="_blank"><i class="lg_msg_avatar setting_i"></i>&nbsp;</a>
            ...
            <em></em>
            <li class="click_track" event-name="l-collections"><a href="http://www.lagou.com/mycenter/collections.html">收藏夹</a>
            </li>
            <em></em>
            <li class="nav-user" id="nav-user-li">
                ...
                <ul class="nav-select" style='z-index:999;'>
                    <li class="click_track" event-name="l-subscribe"><a href="http://www.lagou.com/s/subscribe.html">我的订阅</a>
                    </li>
                    <li class="click_track" event-name="l-logout"><a href="{{url('loginOut.html')}}"
        ...
        <div class="nav-wrapper">
            ...
            <ul class="bottom-right">
                ...
                <li class="" onclick="trackMonitor('l-guide-nav')"><a
                            href="http://pai.lagou.com/talent/guide.html">一拍攻略</a></li>
            </ul>
...
<script type="text/html" id="PAI_C_APPLY_COMPLETE">
    ...
    现在就登录拉勾继续完善在线简历吧~  <a class="complete-link" target="_blank" href="{{url('resumeList')}}">&gt;&gt;
        去完善简历</a>
</script>
...
<script type="text/html" id="PAI_PAI_C_PUSH">
    【拉勾一拍邀请你来参加】拉勾一拍是拉勾网推出的高端招聘产品，汇集行业领域互联网企业，目前服务于有3年以上相关工作经验的北上广深杭成高端候选人，参与拉勾一拍，无须主动投递简历，专场履历展示7天，1V1职业顾问全程跟踪服务，轻松拿到满意offer。
    <a class="complete-link" href="http://pai.lagou.com/index.html" target="_blank" data-lg-tj-id="kr00"
       data-lg-tj-no="idnull" data-lg-tj-cid="idnull">点此报名</a>。
</script>
...
<script type="text/html" id="PAI_PAI_SERVICE_USER_EVALUATION">
    ...
    <a class="to-detail" href="链接地址" target="_blank" data-lg-tj-id="18P0" data-lg-tj-no="idnull"
       data-lg-tj-cid="idnull">去评价顾问</a>
</script>
...
<div class="container">
    ...
    <div class="m-progress s-clearfix">
        <div class="item"><i class="stepEle"><span class="step">1</span></i>

            <p>报名</p>

            <div class="tip first-tip" style="display: block;">
        ...
        <div class="item"><i class="stepEle"><span class="step">2</span></i>
        ...
        <div class="arrow"></div>
        <div class="item"><i class="stepEle"><span class="step">3</span></i>
        ...
        <div class="item"><i class="stepEle"><span class="step">4</span></i>
    ...
    <form id="form">
        ...
        <div class="user">
            ...
            <div class="s-clearfix">
                <div class="input-wrapper userName-wrapper">
                    <input type="text" data-tip-title="称呼" data-tip-content="请填写你的真实姓名。当你接受HR的邀约前，真实姓名对他们不可见。"
                           name="userName" id="userName" placeholder="真实姓名" class="tip-show" value=""/>
                ...
                <div class="input-wrapper identify-input-wrapper">
                    <div class="select-wrapper identify-select-wrapper">
                        <span id="selectIdentity"
                              class="input select-title select-click select-wrapper-default identity-input tip-show"
                              data-tip-title="称呼" data-tip-content="请填写你的真实姓名。当你接受HR的邀约前，真实姓名对他们不可见。">女士/先生</span>
                        <i class="select-triangle select-click tip-show" data-tip-title="称呼"
                           data-tip-content="请请填写你的真实姓名。当你接受HR的邀约前，真实姓名对他们不可见。"></i>
        ...
        <div class="input-wrapper"><label>期望职位</label>
            ...
            <ul class="radio-wrapper radio col-5 tip-show" data-expectPosition="" data-property="" data-tip-title="期望职位"
                data-tip-content="一拍目前只专注于服务互联网相关行业的技术、产品、设计、运营、市场5个领域的高端候选人。如果你的期望不属于以上类别请斟酌是否报名。">
                ...
                <li class="last"><label for="field5">市场</label><input type="radio" name="field" id="field5" value="5"/>
                </li>
            </ul>
            <!-- 技术 -->
        ...
        <div class="input-wrapper">
            ...
            <div class="select-wrapper ">
                <span id="selectYear" data-tip-title="工作经验"
                      ...
                      class="input select-title select-click select-wrapper-default tip-show">请选择...</span>
                <i class="select-triangle select-click tip-show" data-tip-title="工作经验"
                   data-tip-content="一拍目前专注于服务工作经验3年以上的互联网从业人员。如果你的工作经验少于3年请斟酌是否报名。"></i>
        ...
        {{--<div class="contact-parent s-clearfix">--}}
            {{--<div class="input-wrapper contact-wrapper">--}}
                ...
                {{--<input type="text" data-tip-title="手机号码&邮箱地址"--}}
                       {{--data-tip-content="电话和邮件是我们的顾问和HR与你联系的重要途径，请准确填写。你的联系方式只有当你接受HR的邀约后才对他们可见，否则会一直隐藏。"--}}
                       {{--name="phoneNumber" id="phoneNumber" class="tip-show" value=""/>--}}
            ...
            {{--<div class="input-wrapper verify-input">--}}
                ...
                {{--<input type="text" data-tip-title="手机号码&邮箱地址"--}}
                       {{--data-tip-content="电话和邮件是我们的顾问和HR与你联系的重要途径，请准确填写。你的联系方式只有当你接受HR的邀约后才对他们可见，否则会一直隐藏。"--}}
                       {{--class="tip-show" name="phone-verify-codes" id="phone-verify-codes" placeholder="输入验证码"--}}
                       {{--autocomplete="off" maxlength="6"/>--}}

                {{--<div class="error-tip"></div>--}}
            {{--</div>--}}
            {{--<div class="verify-wrapper">--}}
                {{--<a data-tip-title="手机号码&邮箱地址"--}}
                   {{--data-tip-content="电话和邮件是我们的顾问和HR与你联系的重要途径，请准确填写。你的联系方式只有当你接受HR的邀约后才对他们可见，否则会一直隐藏。"--}}
                   {{--class="verify-btn tip-show" href="javascript:;">获取验证码</a>--}}
            {{--</div>--}}
        {{--</div>--}}
        <div class="input-wrapper">
            ...
            <input type="text" data-tip-title="手机号码&邮箱地址"
                   data-tip-content="电话和邮件是我们的顾问和HR与你联系的重要途径，请准确填写。你的联系方式只有当你接受HR的邀约后才对他们可见，否则会一直隐藏。"
                   class="inputMailList tip-show" name="email" id="email" value="" autocomplete="off"/>
        ...
        <div class="salary-range">
            ...
            <div class="s-clearfix">
                <div class="input-wrapper salary-wrapper">
                    <input type="text" data-tip-title="期望月薪" data-tip-content="我们的服务定位于服务互联网高端人才。我们希望你的薪资水平能够达到15K/月。"
                           name="salary-range-start" id="salary-range-start" placeholder="最低期望月薪" class="tip-show"
                           value=""/>
                </div>
                <div class="input-follow">&nbsp;k&nbsp;&nbsp;&nbsp;&nbsp;</div>
                <div class="input-wrapper salary-wrapper">
                    <input type="text" data-tip-title="期望月薪" data-tip-content="我们的服务定位于服务互联网高端人才。我们希望你的薪资水平能够达到15K/月。"
                           name="salary-range-end" id="salary-range-end" placeholder="最高期望月薪" class="tip-show"
                           value=""/>
                </div>
                <div class="input-follow">&nbsp;k</div>
            </div>
        ...
        <div class="current-salary">
            ...
            <div class="s-clearfix">
                <div class="input-wrapper salary-wrapper">
                    <input type="text" name="currentSalary" id="currentSalary" placeholder="当前月薪" class="tip-show"
                           value=""/>
        ...
        <div class="input-wrapper checkbox">
            ...
            <ul class="checkbox-wrapper tip-show" data-tip-title="期望工作地点"
                data-tip-content="我们提供服务的城市目前有北京、上海、广州、深圳、杭州、成都。如果你的期望不包含以上城市，我们可能难以帮助到你。">
                ...
                <li class="last"><label for="city6">成都</label><input type="checkbox" name="expectCity" id="city6"
                                                                     value="成都"/></li>
            </ul>
            <div class="error-tip"></div>
        </div>
        ...
        <div class="input-wrapper">
            ...
            <div class="select-wrapper">
                <span id="selectIntention" data-tip-title="求职意向" data-tip-content="你的求职意向仅作为顾问审核和推荐时的参考信息，不会向HR展示。"
                      name="jobIntention" id="jobIntention"
                      class="input select-title select-click select-wrapper-default tip-show">请选择你的求职意向</span>
        ...
        <div class="input-wrapper self-intro">
            ...
            <div class="textarea-wrapper">
                <textarea rows="10" cols="65" id="self-intro-content" class="tip-show" data-tip-title="自我介绍"
                          data-tip-content="好的自我总结可以让HR更好的了解你，帮助你获得更好的机会。你也可以参考我们给出的模板，50～200字即可。"></textarea>
