    ...
    <div style="display:none;">
        ...
        <div class="popup" id="downloadOnlineResume">
            <table width="100%">
                ...
                <tr>
                    <td>
                        <a class="btn_s" href="{{url('companyResume')}}?key={{csrf_token()}}&type=1&rere_id={{$re_re['rere_id']}}&r_id={{$resume['r_id']}}&name={{$resume['r_name']}}">word格式</a>
                        <a class="btn_s" href="{{url('companyResume')}}?key={{csrf_token()}}&type=2&rere_id={{$re_re['rere_id']}}&r_id={{$resume['r_id']}}&name={{$resume['r_name']}}">html格式</a>
                        <a class="btn_s" href="{{url('companyResume')}}?key={{csrf_token()}}&type=3&rere_id={{$re_re['rere_id']}}&r_id={{$resume['r_id']}}&name={{$resume['r_name']}}">pdf格式</a>
                    </td>
                </tr>
                </tbody>
            </table>
