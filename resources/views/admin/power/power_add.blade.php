		        ...
		        <div class="tab-panel active" id="tab-set">
		            <form method="post" class="form-x" action="powerEdit">
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="field">
		                        <input type="text" class="input" id="p_name" name="p_name"  size="50" placeholder="权限名" data-validate="required:请填写权限的名称" />
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="field">
		                        <input type="text" class="input" id="p_route" name="p_route" size="50" placeholder="路由" data-validate="required:请填写路由" />
		                    </div>
		                </div>
		                  <div class="form-group">
