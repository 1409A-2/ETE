        ...
        $(".projectForm").each(function () {
            $(this).validate({
                ...
                submitHandler: function (a) {
                    var b = $('input[name="projectName"]', a).val(), c = $('input[name="thePost"]', a).val(), e = $('input[name="projectYearStart"]', a).val(), f = $('input[name="projectMonthStart"]', a).val(), g = $('input[name="projectYearEnd"]', a).val(), h = $('input[name="projectMonthEnd"]', a).val(), i = "项目描述" != $('textarea[name="projectDescription"]', a).val() ? $('textarea[name="projectDescription"]', a).val() : "", j = $("#resumeId").val(), l = $("#resumeId").val(), m = $("#project_token").val();
                      $.ajax({
                        url: "porjectAdd",
                        type: "POST",
                          dataType: "json",
                        data: {
                          ...
                          for(i in msg){
                                 ...
                                 html+='<a href="javascript:;"  class="porjectDel" pid="'+msg[i].p_id+'" style="font-size: 18px;color:red">删除</a>';
                                 html+='</span>';
                ...
                submitHandler: function (a) {
                    ...
                    $.ajax({
                        ...
                        for(var i=0;i<msg.length;i++){
                            ...
                            html+='<a href="javascript:;" class="workDel" wid="'+msg[i].w_id+'" style="font-size: 18px;color:red">删除</a>'
                            html+="</div>"
    ...
    window.onbeforeunload = function () {
        ...
        submitHandler: function (a) {
           ...
           $.ajax({
                ...
                html='<span> 北京，全职，月薪'+msg['re_salarymin']+'k-'+msg['re_salarymax']+'k，职位(<font color="red">'+msg['ex_name']+'</font>)</span> <br/> <a href="javascript:;" onclick="expectedDel('+msg['r_id']+')" style="font-size: 18px;color:red">删除</a>'
            ...
            $(this).validate({
                ...
                submitHandler: function (a) {
                    ...
                    $.ajax({
                        ...
                        html+='<a href="javascript:;" onclick="schoolDel('+b['id']+')" style="font-size: 18px;color:red">删除</a>';
