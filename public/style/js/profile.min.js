...
!function (a, b) {
    ...
    window.onbeforeunload = function () {
        ...
        submitHandler: function (a) {
            var c = $('#salaryMin').val(), d = $('#salaryMax').val(), e = "期望职位，如：产品经理" != $('input[name="expectPosition"]', a).val() ? $('input[name="expectPosition"]', a).val() : "", f = $('input[name="expectSalary"]', a).val(), g = $("#resumeId").val(), h = $("#resubmitToken").val();
            $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                url:"expectedAdd",
                type: "POST",
