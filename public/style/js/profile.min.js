...
!function (a, b) {
    ...
    $(function () {
                ...
                $(this).validate({
                    ...
                    submitHandler: function (a) {
                        var b = $('input[name="projectName"]', a).val(),
                            ...
                            i = $('textarea[name="projectDescription"]', a).val(),
                            j = $("#resumeId").val(),
                            l = $("#resumeId").val(),
                            m = $("#project_token").val(),
                            n = $('#porjectId').val();
                        $.ajax({
                            ...
                            html = ""
                            for (i in msg) {
                                html += '<ul class="plist clearfix">';
                                html += '<li class="noborder">';
                                html += '<div class="projectList">';
                                html += '<div class="f16 mb10">' + msg[i].p_name + ',' + msg[i].p_duties;
                                html += '<span class="c9">（' + getLocalTime(msg[i].p_start_time) + '-' + getLocalTime(msg[i].p_end_time) + '）';
                                html += '<a href="javascript:;"  class="porjectDel" pid="' + msg[i].p_id + '" style="font-size: 14px;">删除</a>';
                                html += '<br/>' + msg[i].p_desc;
                                html += '</span>';
                                html += '</div><div class="dl1"></div> </div> </li> </ul> <hr/>'
                            }

                            $("#projectExperience .projectEdit").addClass("dn");
                            $("#projectExperience .projectEd").addClass("dn");
                            $("#projectExperience .projectShow").removeClass("dn").html(html);
        ...
        function getLocalTime(nS) {
            return new Date(parseInt(nS) * 1000).toLocaleString().substr(0,7)
        }
        ...
        function i() {
            $(".workForm").each(function () {
                $(this).validate({
                    rules: {
                        workLink: {required: !0, checkUrlNot: !0, maxlength: 150},
                        workDescription: {required: !0, maxlength: 100}
                    },
                    messages: {
                    ...
                    submitHandler: function (a) {
                        var b = "请输入作品链接" != $('input[name="workLink"]', a).val() ? $('input[name="workLink"]', a).val() : "",
                            c = "请输入说明文字" != $('textarea[name="workDescription"]', a).val() ? $('textarea[name="workDescription"]', a).val() : "", d = $("#resumeId").val(), e = $("#resumeId").val(), f = $("#token_work").val();
                        $.ajax({
                            url: "worksAdd",
                            type: "POST",
                            data: {url: b, workName: c, wsid: d, id: e, _token: f},
                            dataType: "json"
                        }).done(function (msg) {
                            html = '';
                            for (var i = 0; i < msg.length; i++) {
                                html += '<div class="workList">'
                                html += "<div class='f16'>网址：<a target='_blank' href=" + msg[i].w_url + ">" + msg[i].w_url + "</a>"

                                html += '<a href="javascript:;" class="workDel" wid="' + msg[i].w_id + '" style="font-size: 14px; margin-left: 30px;">删除</a>'
                                html += "</div>"
                                html += "<p>" + msg[i]['w_desc'] + "</p>"
                                html += "<hr/></div>"
                            }

                            $("#worksShow .workEdit").addClass("dn");
                            $("#worksShow .workAd").addClass("dn");
                            $("#worksShow .workShow").removeClass("dn").html(html);
                            $("#worksShow .c_add").removeClass("dn");
                        })
                    }
                })
            })
        ...
        window.onbeforeunload = function () {
            ...
            $("#profileForm").validate({
                ...
                submitHandler: function (a) {
                    ...
                    $.ajax({
                        ...
                        html = '';
                        html += '<span>' + msg['r_name'] + '|';
                        if (msg['r_sex'] == 1) {
                            html += '女|';
                        } else {
                            html += '男|';
                        }
                        html += msg['r_education'];
                        html += '<br/>';
                        html += msg['r_photo'];
                        html += '|' + msg['r_email'] + '<br/>' + msg['r_status'];
                        html += '</span><div class="m_portrait"><div></div>';
                        if (msg['r_img']) {
                            html += '<img width="120" height="120"  src="' + URL + '/' + msg['r_img'] + '"/>'
                        } else {
                            html += '<img width="120" height="120" alt="jason" src="' + URL + '/style/images/default_headpic.png"/>'
                        }
                        html += '</div>';
                        $('#basicInfo .basicShow').removeClass('dn').html(html);
            ...
            Add: function () {
                this.obj.find(".expectAdd").addClass("dn"),
                    ...
                    this.obj.find(".expectAd").removeClass("dn"),
                    j(this.obj)
            },
            Edit: function () {
            ...
            Cancelec: function () {
                ...
                $(".c_edit").addClass("dn");
                $(".expectAd").addClass("dn");
                this.obj.find(".expectAdd").removeClass("dn");
            }
        }, b.obj.find(".expectAdd").bind("click", function () {
            b.Add()
        }), b.obj.find(".c_edit").bind("click", function () {
            b.Edit()
        }), $(".expectEdit .btn_profile_cancel").bind("click", function () {
            b.Cancel()
        }), $(".expectAd .btn_profile_cancel").bind("click", function () {
            b.Cancelec()
            ...
            rules: {
                ...
                expectPosition: {required: true, specialchar: !0, checkNum: !0, minlength: 2, maxlength: 100},
            ...
            submitHandler: function (a) {
                ...
                $.ajax({
                    url: "expectedAdd",
                    type: "POST",
                    data: {salaryMin: c, salaryMax: d, positionName: e, salarys: f, id: g, _token: h},
                    dataType: "json"
                }).done(function (msg) {
                    html = '<span> 北京，全职，月薪' + msg['re_salarymin'] + 'k-' + msg['re_salarymax'] + 'k，职位(<font color="red">' + msg['ex_name'] + '</font>)</span> <br/> <a href="javascript:;" onclick="expectedDel(' + msg['r_id'] + ')" style="font-size: 14px;">删除</a>'
                    $("#expectJob .expectEdit").addClass("dn");
                    $("#expectJob .expectAdd").addClass("dn");
                    $("#expectJob .expectAd").addClass("dn");
                    $("#expectJob .expectShow").removeClass("dn").html(html);
        ...
        $(".select_companyYearStart").bind("click", function (a) {
            ...
            $(this).validate({
                ...
                submitHandler: function (a) {
                    var b = $('input[name="companyName"]', a).val(), d = $('input[name="positionName"]', a).val(), e = $('input[name="companyYearStart"]', a).val(), f = $('input[name="companyMonthStart"]', a).val(), g = $('input[name="companyYearEnd"]', a).val(), h = $('input[name="companyMonthEnd"]', a).val(), i = $(".expId", a).val(), j = $("#resumeId").val(), l = $("#resubmitToken").val();
            ...
            obj: $("#projectExperience"), resetForm: function () {
                ...
                this.resetForm(), placeholderFn(),
                    ...
                    this.obj.children(".projectEd").removeClass("dn"),
                    e(),
                    j(this.obj)
            }, Edit: function (a) {
                ...
                this.obj.find(".projectAdd").removeClass("dn"),
                    ...
                    k(this.obj)
            }, AddCancelss: function () {

                this.obj.find(".projectEd").addClass("dn"),
                    this.obj.find(".c_add").removeClass("dn"),
                    k(this.obj)
            },
            ...
            d.AddCancel()
        }), d.obj.children(".projectEd").find(".btn_profile_cancel").bind("click", function () {
            d.AddCancelss()
            ...
            f = {
                ...
                schoolYearEndVal: "",
                Add: function () {
                    this.obj.children(".educationalAd").find(".schoolName").val(""),
                        this.obj.children(".educationalAd").find(".degree").val(""),
                        this.obj.children(".educationalAd").find(".select_degree").css("color", "#999").val("学历"),
                        this.obj.children(".educationalAd").find(".professionalName").val(""),
                        this.obj.children(".educationalAd").find(".schoolYearStart").val(""),
                        this.obj.children(".educationalAd").find(".select_schoolYearStart").css("color", "#999").val("开始年份"),
                        this.obj.children(".educationalAd").find(".schoolYearEnd").val(""),
                        this.obj.children(".educationalAd").find(".select_schoolYearEnd").css("color", "#999").val("结束年份"), placeholderFn(),
                        this.obj.children(".educationalAdd").addClass("dn"),
                        this.obj.children(".educationalAd").removeClass("dn"),
                        j(this.obj)
                },
                AddMore: function () {
                ...
                Edit: function (a) {
                    ...
                    this.obj.children(".educationalShow").find(".schoolName").val(g),
                        ...
                        this.obj.children(".educationalShow").find(".eduId").val(b), $(".educationalForm").validate().element($(".schoolYearStart")),
                        this.obj.children(".educationalShow").children(".educationalForm").show(),
                        this.schoolNameVal = g, this.degreeVal = e,
                        this.professionalNameVal = f, this.schoolYearStartVal = c, this.schoolYearEndVal = d, this.obj.children(".c_add").addClass("dn"), j(this.obj)
                },
                Del: function (a) {
                    var b = a.parent("li").attr("data-id");
                    $.ajax({
                ...
                AddCancel: function () {
                    this.obj.find(".educationalShow").removeClass("dn"),
                        this.obj.find(".educationalEdit").addClass("dn"),
                        k(this.obj)
                },
                AddMoreCancel: function () {

                    this.obj.children(".educationalShow").first().removeClass('dn'),
                        this.obj.children(".educationalShow").last().addClass('dn'),

                        k(this.obj)
                },
                AddCanc: function () {
                    this.obj.children(".educationalAdd").removeClass('dn')
                    this.obj.children(".educationalAd").addClass('dn')
                }
            }, f.obj.find(".educationalAdd").bind("click", function () {
            f.Add()
        }), f.obj.find(".c_add").bind("click", function () {
            f.AddMore()
        }), f.obj.find(".c_edit").bind("click", function () {
            f.AddMore()
            ...
            f.AddCancel()
        }), f.obj.children(".educationalAd").find(".btn_profile_cancel").bind("click", function () {
            f.AddCanc()
            ...
            $(".educationalForm").each(function () {
                $(this).validate({
                    ...
                    submitHandler: function (a) {
                        var b = $('input[name="schoolName"]', a).val(), c = $('input[name="degree"]', a).val(), d = $('input[name="professionalName"]', a).val(), e = $('input[name="schoolYearStart"]', a).val(), g = $('input[name="schoolYearEnd"]', a).val(), h = $(".eduId", a).val(), i = $("#resumeId").val(), j = $("#resubmitTokens").val();
                        $.ajax({
                            url: "schoolPro",
                            type: "POST",
                            data: {
                            ...
                            html = '';
                            html += '<span>学校名称——<b>' + b.schoolName + '</b>   <br/>最高学历——<b>' + b.education + '</b> <br>';
                            html += '专业———— <b> ' + b.professional + ' </b> <br/> 在校历程—— <b> ' + b.startYear + '—' + b.endYear + ' </b><br>';
                            html += '<a href="javascript:;" onclick="schoolDel(' + b['id'] + ')" style="font-size: 14px;">删除</a>';
                            $("#educationalBackground .educationalAd").addClass("dn");
                            $("#educationalBackground .educationalShow").removeClass("dn").html(html);
            ...
            $(".descriptionForm").validate({
                ...
                submitHandler: function (a) {
                    ...
                    $.ajax({
                        url: "educationDesc",
                        type: "POST",
                        data: {myRemark: b, id: c, _token: d},
                        dataType: "json"
                    }).done(function (b) {
                        if (b) {
                            $("#selfDescription .descriptionEdit").addClass("dn");
                            $("#selfDescription .descriptionShow").removeClass("dn").html(b.r_desc);
            ...
            obj: $("#worksShow"), resetForm: function () {
                ...
                this.resetForm(), placeholderFn(),
                    ...
                    this.obj.children(".workAd").removeClass("dn"),
                    this.obj.children(".workEdit").addClass("dn"),
                    j(this.obj)
            }, AddMore: function () {
                this.resetForm(),
                    //this.obj.children(".workEdit").prepend(this.obj.children(".workEdit").children("form").clone()),
                ...
                this.obj.find(".workShow").removeClass("dn"),
                    this.obj.find(".workEdit").addClass("dn"),
                    this.obj.find(".workAdd").addClass("dn"),
                    this.obj.find(".c_add").removeClass("dn")

                k(this.obj)
            }, AddCancele: function () {
                this.obj.find(".workShow").addClass("dn"),
                    this.obj.find(".c_add").addClass("dn"),
                    this.obj.find(".workEdit").addClass("dn"),
                    this.obj.find(".workAd").addClass("dn"),
            ...
            h.AddCancel()
        }), h.obj.children(".workAd").find(".btn_profile_cancel").bind("click", function () {
            h.AddCancele()
        }),
