$(function () {
    ...
    //     type_selected = $('.type_selected').html();
    //     i_name = $("#search_input").val();
    //     k = $('#k').val();
    //     education = $('#education').val();
    //     location.href = "jump?k=" + k + "&i_name=" + i_name + "&education=" + education + "&type_selected=" + type_selected;
    // });
    $(window).resize(function () {
        ...
        1 == b ? $('#type_selected').val('1') : $('#type_selected').val('4');     
