...
$(function () {
    ...
    window.onbeforeunload = function () {
    ...
    }), b = {expires: 1}, null == $.cookie("viewTimes") ? ($("#stepTip img").attr("src", ctx + "/style/images/tiponce.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", "1", b)) : (c = parseInt($.cookie("viewTimes")) + 1, $("#stepTip img").attr("src", ctx + "/style/images/tiponce.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", c, b)), $(document).click(function () {
        var a = [];
        ...
        messages: {
            ...
            positionAddress: {required: "请选择公司总部的位置"}
        },
